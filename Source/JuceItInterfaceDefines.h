...
#define JUCEIT_FILTER_BORDER 2

//Filter Component Constants
#define MIN_X_COORDINATE_POSITION 3.0f
#define MIN_Y_COORDINATE_POSITION 0.f
#define MAX_Y_COORDINATE_POSITION 172.0f
#define FILTER_HEIGHT 160.0f
#define MAX_X_COORDINATE_POSITION JUCEIT_FILTER_BOUNDS-MIN_X_COORDINATE_POSITION
